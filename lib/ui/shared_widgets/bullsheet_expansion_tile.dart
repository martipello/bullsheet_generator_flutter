...
/// [BullsheetExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [BullsheetExpansionTile].
///
...
class BullsheetExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const BullsheetExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  /// The primary tap of the list item.
  ///
  /// Doesnt control the state.
  ...
  @override
  State<BullsheetExpansionTile> createState() => _BullsheetExpansionTileState();
}

class _BullsheetExpansionTileState extends State<BullsheetExpansionTile> with SingleTickerProviderStateMixin {
  ...
  Widget _buildTrailingIcon(BuildContext context) {
    if (_effectiveAffinity(widget.controlAffinity) != ListTileControlAffinity.trailing) return const SizedBox();
            ...
            child: Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  splashRadius: 24,
                  icon: widget.trailing ?? _buildTrailingIcon(context),
                ),
              ],
            ),
          ),
